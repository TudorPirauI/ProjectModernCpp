...
//
// ITurneu::ITurneu(const std::string &nameOne, const std::string &nameTwo,
//                  const std::array<bool, 3> &options, QWidget *parent) :
//     QWidget(parent), m_CurrentGame(nameOne, nameTwo, options),
//     m_CurrentPlayer(PlayerTurn::Player1), m_SelectedCard(std::nullopt), m_ParentWidget(parent) {
//
//     const auto mainLayout = new QVBoxLayout(this);
//
//     m_BoardWidget = new BoardWidget(this, 3);
//     m_BoardWidget->setFixedSize(600, 600);
//     connect(m_BoardWidget, &BoardWidget::BoardSlotClicked, this, &ITurneu::OnPositionSelected);
...
//     connect(m_HandWidget, &HandWidget::CardSelected, this, &ITurneu::OnCardSelected);
//
...
// }
//
// void ITurneu::OnCardSelected(const int cardValue) {
//     m_SelectedCard = Card(cardValue);
//     qDebug() << "[Slot] Card selected with value:" << m_SelectedCard.value().GetValue() << '\n';
// }
//
// void ITurneu::OnPositionSelected(const int x, const int y) {
