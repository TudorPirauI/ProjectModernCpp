...
//     connect(m_BoardWidget, &BoardWidget::BoardSlotClicked, this, &IRapid::OnPositionSelected);
...
//     connect(m_HandWidget, &HandWidget::CardSelected, this, &IRapid::OnCardSelected);
//
...
// }
//
// void IRapid::OnCardSelected(const int cardValue) {
//     m_SelectedCard = Card(cardValue);
//     qDebug() << "[Slot] Card selected with value:" << m_SelectedCard.value().GetValue() << '\n';
// }
//
// void IRapid::OnPositionSelected(const int x, const int y) {
